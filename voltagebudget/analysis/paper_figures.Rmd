...
fig2 %>% 
  ...
  labs(x=expression(V[o]/V[b]), y="Norm. error") +
...
fig2 %>% 
  ...
  geom_vline(xintercept = 1, alpha=0.7, color="black", linetype="dashed") +
  geom_vline(xintercept = 0.5, alpha=0.5, color="black", linetype="dashed") +
  labs(x=expression(V[o]/V[b]), y="Norm. variance") +
...
fig12 %>%
  ...
  theme_classic() +
  lims(x=c(0, 3)) +
  labs(x=expression(V[o]/V[b]), y="Norm. error") -> p1
...
fig12 %>%
  ...
  theme_classic() +
  lims(x=c(0, 3)) +
  labs(x=expression(V[o]/V[b]), y="Norm. variance") -> p2
