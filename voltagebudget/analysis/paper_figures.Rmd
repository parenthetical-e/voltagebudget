...
fig2 %>% 
  ...
  labs(x=expression(V[o] (mvolt)), y="Spike count") +
...
fig2 %>% 
  ggplot(aes(x=V_osc*1e3, y=errors*1e3, color=freq, group=freq)) +
  geom_jitter(alpha=0.2, size=0.1) + 
  labs(x=expression(V[o] (mvolt)), y="Error (ms)") +
  scale_color_gradient(low="gold", high="darkgreen") +
  theme_classic() +
...
fig2 %>% 
  ggplot(aes(x=V_osc*1e3, y=variances*1e3, color=freq, group=freq)) +
  geom_jitter(alpha=0.2, size=0.1) + 
  labs(x=expression(V[o] (mvolt)), y="Variance (ms)") +
  scale_color_gradient(low="gold", high="darkgreen") +
  scale_x_continuous(breaks=c(0, 4.0, 8.0, 12.0)) +
