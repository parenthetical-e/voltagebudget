...
tmp %>% 
  ...
  geom_point(size=1.4, alpha=.8, shape=4) +
  geom_point(
    data=filter(tmp, set == "initial"),
    mapping=aes(x=ts*1e3, y=ns), color="black", shape=1, alpha=0.5, size=1.35) +
  facet_grid(alg~.) +
...
fig15 %>% 
  ...
  geom_point(mapping=aes(x=errors_opt*ms, y=variances_opt*ms), color="#e41a1c", alpha=0.6, size=.2) +
