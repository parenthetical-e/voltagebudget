...
fig2 %>% 
  ...
  # Arrow
  # geom_segment(aes(x = 0.27, y = 0.5, xend = -.1, yend = 0.5), 
  #              color="darkslategray3", linetype="solid", size=.3,
  #              lineend = "round", linejoin = "round",
  #              arrow = arrow(length = unit(0.06, "npc"))) +
  # geom_segment(aes(x = .27, y = .5, xend = 0.27, yend = 0), 
  #              color="darkslategray3", linetype="solid", size=.3,
  #              lineend = "round", linejoin = "round",
  #              arrow = arrow(length = unit(0.06, "npc"))) +

  # X
  # geom_point((aes(x=0.27, y=0.5)), color="grey", size=3, shape=4, alpha=0.6) +

  # Line
  geom_vline(xintercept = 0.27, alpha=0.8, color="darkslategray3", linetype="solid") +
  xlab(expression(V[o]/V[c])) +
  ylab("Norm. error") +
  theme_classic() -> p5
fig2 %>% 
  ...
  # Arrow
  # geom_segment(aes(x = 0.28, y = 0.28, xend = -0.1, yend = 0.28), 
  #              color="darkslategray3", linetype="solid", size=.3,
  #              lineend = "round", linejoin = "round",
  #              arrow = arrow(length = unit(0.06, "npc"))) +
  # geom_segment(aes(x = .27, y = .28, xend = 0.27, yend = 0.0), 
  #              color="darkslategray3", linetype="solid", size=.3,
  #              lineend = "round", linejoin = "round",
  #              arrow = arrow(length = unit(0.06, "npc"))) +
